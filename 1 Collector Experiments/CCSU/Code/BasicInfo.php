...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            ...
            <textarea readonly>The purpose of this study is to understand how individuals perceive and understand objects through word recognition and perception. You will be asked to answer a questionnaire related to the possible actions associated with various objects.The experiment will take approximately 30 minutes to complete and you will receive course credit for participating. The researchers do not expect any risks from participating in this study other than the possibility of slight boredom during task completion. Your participation will be kept confidential. You are free to discontinue at anytime. Your data will be deleted immediately after you withdraw. This project is being conducted in conjunction with the University of Southern Mississippi. Both the project and the consent form have been reviewed by the Institutional Review Board at the University of Southern Mississippi. Any questions should be directed to blau@ccsu.edu</textarea>
            <label>
