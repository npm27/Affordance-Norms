...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            ...
            <textarea readonly>The purpose of this study is to understand how individuals perceive and understand objects based on object use. Objects differ in the number of action possibilities (termed affordances), and our study will provide an assessment of different object uses and frequently an affordance is listed for a specific object. In this study, you will make ratings for about 30 different words that represent common objects. Your task will be to list as many possible actions as you can for each object. The experiment will take approximately 15 minutes to complete and you will be compensated at a rate of $2.50/per session ($10.00/hour). The researchers do not expect any risks from participating in this study other than the possibility of slight boredom during task completion. There are no direct benefits to your participation. However, you will be exposted to some of the latest research that is being conducted on human cognition and perceptual processing. Your participation will be kept confidential. You are free to discontinue at anytime. Your data will be deleted immediately after you withdraw. This project and the consent form have been reviewed and approved by the Institutional Review Board (IRB) at the University of Southern Mississippi. General questions about today's study should be directed to mark.huff@usm.edu or nicholas.maxwell@msutexas.edu</textarea>
            <label>
