...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            ...
            <textarea readonly>The purpose of this study is to understand how individuals perceive and understand objects based on object use. Objects differ in the number of action possibilities (termed affordances), and our study will provide an assessment of different object uses and frequently an affordance is listed for a specific object. In this study, you will make ratings for about 30 different words that represent common objects. Your task will be to list as many  possible actions as you can for each object. The experiment will take approximately 30 minutes to complete and you will receive 1 credit for participating from The University of South Alabama (USA) sona-systems research participant pool. The researchers do not expect any risks from participating in this study other than the possibility of slight boredom during task completion. There are no direct benefits to your participation. However, you will be exposted to some of the latest research that is being conducted on human cognition and perceptual processing. Your participation will be kept confidential. You are free to discontinue at anytime. Your data will be deleted immediately after you withdraw. This project and the consent form have been reviewed by the Institutional Review Board (IRB) at the University of South Alabama. You may contact the IRB at 251-460-6308 or email irb@southalabama.edu. General questions about today's study should be directed to jstremblay@southalabama.edu</textarea>
            <label>
