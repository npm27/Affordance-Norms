...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            ...
            <textarea readonly>The purpose of this study is to understand how individuals perceive and understand objects based on object use. Objects differ in the number of action possibilities (termed affordances), and our study will provide an assessment of different object affordances and how frequently an affordance is listed for a given object. In this study, you will be presented with a set of 30 objects. Your task will be to list as many possible actions for each object. The experiment will take approximately 30 minutes to complete and you will receive .5 credits toward your Introduction to Psychology course for your participation. The researchers do not expect any risks from participating in this study other than the possibility of slight boredom during task completion. Your participation will be kept confidential. You are free to discontinue at anytime. Your data will be deleted immediately after you withdraw. This project and the consent form have been reviewed by the Hope College Human Subjects Review Board. If you have any concerns regarding this study or questions about your rights as a resarch participant, you may contact the review board (hsrb@hope.edu) or its chair, Daryl VanTongeren (vantongeren@hope.edu). General questions about your participation today should be directed to the principle investigator, Benjamin R. Meagher (meagher@hope.edu)</textarea>
            <label>
