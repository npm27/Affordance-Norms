...
##read in data
master = read.csv("0-Data/Merged_CCSU_5_24_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "not sire"] = NA
dat$affordance_response[dat$affordance_response == "what"] = NA
dat$affordance_response[dat$affordance_response == "like what even is this"] = NA
dat$affordance_response[dat$affordance_response == "it's what i call your girlfriend, please let me out"] = NA
dat$affordance_response[dat$affordance_response == "no answer "] = NA
dat$affordance_response[dat$affordance_response == "something to do with cars (no idea)"] = NA

#remove the weirdo
#dat = subset(dat,
 #            dat$Username != "matt.huston@my.ccsu.edu")
...
##Write to .csv
#write.csv(combined, file = "CCSU Cleaned 5_24_23.csv", row.names = F)
