...
##read in data
master = read.csv("0-Data/Merged_Clemson_12_20.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "dog???"] = NA
dat$affordance_response[dat$affordance_response == "take part in it (idk what this is)"] = NA
dat$affordance_response[dat$affordance_response == "i have no clue"] = NA
dat$affordance_response[dat$affordance_response == "i am unsure what this object is"] = NA
...
##Write to .csv
#write.csv(combined, file = "Clemson Cleaned 12_20_22.csv", row.names = F)
