...
##read in data
master = read.csv("0-Data/Merged_Hope_5_25_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i don't know what this word means :("] = NA
dat$affordance_response[dat$affordance_response == "not sure what this is :("] = NA
dat$affordance_response[dat$affordance_response == "what is a lobe. like an ear lobe? touch it, bite it, pierce it"] = "touch, bite, pierce"
dat$affordance_response[dat$affordance_response == "not an object"] = NA
dat$affordance_response[dat$affordance_response == "not used for much unless this object is motivated"] = NA
dat$affordance_response[dat$affordance_response == "idk this word"] = NA
dat$affordance_response[dat$affordance_response == "bill cosby?"] = NA
dat$affordance_response[dat$affordance_response == "no idae"] = NA
...
##Write to .csv
#write.csv(combined, file = "Hope Cleaned 5_25_23.csv", row.names = F)
