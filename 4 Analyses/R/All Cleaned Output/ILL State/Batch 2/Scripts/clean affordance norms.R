...
##read in data
master = read.csv("0-Data/Merged_IL_State_7_21.csv", stringsAsFactors = F)
...
#Fix column names
colnames(parsed_afforances)[6] = c("affordance_corrected")
...
combined = cbind(no_stop, lemmatized[ , c(9:11, 13)])
...
##Write to .csv
#write.csv(combined, file = "ILL STATE  Cleaned 7_21_23_2.csv", row.names = F)
#write.csv(dat, file = "ILL State.csv", row.names = F)
