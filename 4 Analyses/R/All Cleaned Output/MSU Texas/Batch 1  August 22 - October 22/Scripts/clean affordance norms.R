...
##read in data
master = read.csv("0-Data/Merged_MSU_Texas_10_15.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i am unsure what a lounger is."] = NA
...
##Write to .csv
#write.csv(combined, file = "MSU Texas Cleaned 10_15_22.csv", row.names = F)