...
##read in data
master = read.csv("0-Data/Merged_MSU_Texas_2_26_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "not sure what this word means"] = NA
...
##Write to .csv
#write.csv(combined, file = "MSU Texas Cleaned 2_26_23.csv", row.names = F)
