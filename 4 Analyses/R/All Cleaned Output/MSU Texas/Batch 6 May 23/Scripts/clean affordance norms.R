...
##read in data
master = read.csv("0-Data/Merged_MSU_Texas_6_17.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i am not familiar with this object"] = NA
dat$affordance_response[dat$affordance_response == "i have no use for this object"] = NA
dat$affordance_response[dat$affordance_response == "i am unfamiliar with this object"] = NA
...
##Write to .csv
#write.csv(combined, file = "MSU Texas Cleaned 6_17_23.csv", row.names = F)
