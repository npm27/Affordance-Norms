...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch10.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i/m not sure of this"] = NA
dat$affordance_response[dat$affordance_response == "no idea what this is sorry"] = NA
dat$affordance_response[dat$affordance_response == "unsuer"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 10 Cleaned.csv", row.names = F)
