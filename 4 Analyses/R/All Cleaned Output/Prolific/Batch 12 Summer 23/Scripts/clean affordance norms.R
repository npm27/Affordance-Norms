...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch12.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i'm not sure how you'd use this"] = NA
dat$affordance_response[dat$affordance_response == "not sure on how to use a brow"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 12 Cleaned.csv", row.names = F)
