...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch13.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "eat? not really sure"] = "eat"
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 13 Cleaned.csv", row.names = F)
