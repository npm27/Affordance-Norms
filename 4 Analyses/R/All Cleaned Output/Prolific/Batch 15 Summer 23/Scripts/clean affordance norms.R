...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch15.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "im not sure what this means sorry"] = NA
dat$affordance_response[dat$affordance_response == "no"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 15 Cleaned.csv", row.names = F)
