...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch17.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "don't know this word, sorry"] = NA
dat$affordance_response[dat$affordance_response == "i don't know what this is, sorry"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 17 Cleaned.csv", row.names = F)
