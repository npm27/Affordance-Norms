...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch4.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "not a word"] = NA
dat$affordance_response[dat$affordance_response == "cubical is an adjective. you cannot do anything with an adjective. perhaps the word here should have been cubicle."] = NA
dat$affordance_response[dat$affordance_response == "create a sword? not sure"] = NA
...
dat$affordance_response[dat$affordance_response == "what item?"] = NA
dat$affordance_response[dat$affordance_response == "sorry i don't know what a houseboy is"] = NA
dat$affordance_response[dat$affordance_response == "???"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 4 Cleaned.csv", row.names = F)
