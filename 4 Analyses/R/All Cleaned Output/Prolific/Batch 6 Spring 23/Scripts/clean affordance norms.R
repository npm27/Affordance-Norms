...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch6.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "god knows"] = NA
dat$affordance_response[dat$affordance_response == "no idea what this is"] = NA
dat$affordance_response[dat$affordance_response == "no idea what this is "] = NA
dat$affordance_response[dat$affordance_response == "whatever"] = NA
dat$affordance_response[dat$affordance_response == "impossible, you cannot use a person"] = NA
dat$affordance_response[dat$affordance_response == "you can't"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 6 Cleaned.csv", row.names = F)
