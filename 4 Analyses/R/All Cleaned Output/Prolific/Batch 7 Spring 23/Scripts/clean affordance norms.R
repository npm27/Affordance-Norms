...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch7.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i don't know what a coverall is"] = NA
...
dat$affordance_response[dat$affordance_response == "i dont know what this object is"] = NA
dat$affordance_response[dat$affordance_response == "dont know what a burlap is"] = NA
dat$affordance_response[dat$affordance_response == "a what"] = NA
dat$affordance_response[dat$affordance_response == "unsure what it is but here i go,to keep your hair off your face,for stop sweating,for playing baseball"] = NA
dat$affordance_response[dat$affordance_response == "to tape papers,im unsure what it is"] = NA
dat$affordance_response[dat$affordance_response == "shes not an object"] = NA
dat$affordance_response[dat$affordance_response == "it is not an object, but we can take steps to protect and preserve the environment for the benefit of the whole world"] = NA
dat$affordance_response[dat$affordance_response == "???"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 7 Cleaned.csv", row.names = F)
