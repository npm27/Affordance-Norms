...
##read in data
master = read.csv("0-Data/Merged_Prolific_Batch9.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "don't know a use"] = NA
dat$affordance_response[dat$affordance_response == "dont know, no idea"] = NA
dat$affordance_response[dat$affordance_response == "i don't have penny, my penny lost"] = "lose"
dat$affordance_response[dat$affordance_response == "what is that?"] = NA
dat$affordance_response[dat$affordance_response == "use it for what it was designed"] = NA
dat$affordance_response[dat$affordance_response == "throw away, dispose, not use"] = NA
dat$affordance_response[dat$affordance_response == "an object, the best"] = NA
...
##Write to .csv
#write.csv(combined, file = "Prolific Batch 9 Cleaned.csv", row.names = F)
