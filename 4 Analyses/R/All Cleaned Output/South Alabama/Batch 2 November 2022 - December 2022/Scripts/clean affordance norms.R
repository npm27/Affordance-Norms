...
##read in data
master = read.csv("0-Data/Merged_USA_12_10.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "don't remember what the other definition is for this word"] = NA
dat$affordance_response[dat$affordance_response == "i dont knoe"] = NA
dat$affordance_response[dat$affordance_response == "i dont knoe "] = NA
dat$affordance_response[dat$affordance_response == "idk what that is"] = NA
dat$affordance_response[dat$affordance_response == "idk what that is "] = NA
dat$affordance_response[dat$affordance_response == "forgot what these are"] = NA
dat$affordance_response[dat$affordance_response == "not in my vocabulary "] = NA
...
##Write to .csv
#write.csv(combined, file = "USA Cleaned 12_10_22.csv", row.names = F)
