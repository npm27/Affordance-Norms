...
##read in data
master = read.csv("0-Data/Merged_USA_5_27_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i am not a farmer"] = NA
...
##Write to .csv
#write.csv(combined, file = "USA Cleaned 5_27_23.csv", row.names = F)
