...
##read in data
master = read.csv("0-Data/Merged_USA_6_19_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "not using this word except as joke "] = NA
dat$affordance_response[dat$affordance_response == "i do not know"] = NA
dat$affordance_response[dat$affordance_response == "not being able to step up instead using a ramo"] = NA
dat$affordance_response[dat$affordance_response == "i don't know "] = NA
dat$affordance_response[dat$affordance_response == "person, else"] = NA
dat$affordance_response[dat$affordance_response == "person"] = NA
dat$affordance_response[dat$affordance_response == "#name?"] = NA
...
##Write to .csv
#write.csv(combined, file = "USA Cleaned 6_19_23.csv", row.names = F)
