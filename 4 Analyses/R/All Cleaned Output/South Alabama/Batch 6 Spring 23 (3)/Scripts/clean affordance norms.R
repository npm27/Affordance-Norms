...
##read in data
master = read.csv("0-Data/Merged_USA_6_21_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "no id"] = NA
dat$affordance_response[dat$affordance_response == "no use"] = NA
dat$affordance_response[dat$affordance_response == "not sure what is"] = NA
dat$affordance_response[dat$affordance_response == "unknown"] = NA
dat$affordance_response[dat$affordance_response == "i dont know what a hamper is"] = NA
...
##Write to .csv
#write.csv(combined, file = "USA Cleaned 6_21_23.csv", row.names = F)
