...
##read in data
master = read.csv("0-Data/USM_merged_1_30_23_.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "it is not an object"] = NA
...
##Write to .csv
#write.csv(combined, file = "USM Cleaned 1_30_23.csv", row.names = F)
