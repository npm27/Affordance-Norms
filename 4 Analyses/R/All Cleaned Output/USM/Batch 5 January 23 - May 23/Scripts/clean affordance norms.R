...
##read in data
master = read.csv("0-Data/Merged_USM_5_22_23.csv", stringsAsFactors = F)

##only keep the columns we need
dat = master[ , c(1, 5, 11, 13, 19, 34)]
...
dat$affordance_response[dat$affordance_response == "i also don't know uses for this"] = NA
...
dat$affordance_response[dat$affordance_response == "i have no idea what that really is"] = NA
dat$affordance_response[dat$affordance_response == "idk what i would do with a cube"] = NA
dat$affordance_response[dat$affordance_response == "i have no idea what that is"] = NA
dat$affordance_response[dat$affordance_response == "not sjure"] = NA
dat$affordance_response[dat$affordance_response == "im not gonna use my nephew!!"] = NA
dat$affordance_response[dat$affordance_response == "im not gonna use a preschooler gross"] = NA
dat$affordance_response[dat$affordance_response == "i do not know this"] = NA
dat$affordance_response[dat$affordance_response == "poop?"] = NA
dat$affordance_response[dat$affordance_response == "did you go to the saloon last night?"] = NA
dat$affordance_response[dat$affordance_response == "can you?"] = NA
dat$affordance_response[dat$affordance_response == "how"] = NA
dat$affordance_response[dat$affordance_response == "to idk"] = NA
...
##Write to .csv
#write.csv(combined, file = "USM Cleaned 5_22_23.csv", row.names = F)
