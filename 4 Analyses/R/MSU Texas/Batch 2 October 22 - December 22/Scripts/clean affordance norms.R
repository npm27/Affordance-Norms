...
##read in data
master = read.csv("0-Data/Merged_MSU_Texas_12_1.csv", stringsAsFactors = F)
...
##Write to .csv
#write.csv(combined, file = "MSU Texas Cleaned 12_1_22.csv", row.names = F)
