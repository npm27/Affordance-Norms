...
##read in data
master = read.csv("0-Data/Merged_MSU_Texas_4_1_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "i dont know how to use someone"] = NA
...
##Write to .csv
#write.csv(combined, file = "MSU Texas Cleaned 4_1_23.csv", row.names = F)
