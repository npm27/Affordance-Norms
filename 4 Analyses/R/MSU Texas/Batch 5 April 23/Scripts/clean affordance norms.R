...
##read in data
master = read.csv("0-Data/Merged_MSU_Texas_4_12_23.csv", stringsAsFactors = F)
...
dat$affordance_response[dat$affordance_response == "I need to use the bathroom. my friend is in the bathroom, don't go to the bathroom."] = NA
dat$affordance_response[dat$affordance_response == "eat? I don't know "] = NA
dat$affordance_response[dat$affordance_response == "I honestly don't know what this is"] = NA
dat$affordance_response[dat$affordance_response == "don't fall off of the ledge"] = "fall"
...
dat$affordance_response[dat$affordance_response == "not sure what thi is"] = NA
dat$affordance_response[dat$affordance_response == "no use"] = NA
dat$affordance_response[dat$affordance_response == "i do not know this word"] = NA
...
dat$affordance_response[dat$affordance_response == "no clue what this is"] = NA
dat$affordance_response[dat$affordance_response == "i dont really know what this is"] = NA
dat$affordance_response[dat$affordance_response == "i dont even know what that is"] = NA

#dat = subset(dat,
            # dat$Username != "m20307039")
...
##Write to .csv
#write.csv(combined, file = "MSU Texas Cleaned 4_12_23.csv", row.names = F)
